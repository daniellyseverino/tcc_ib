...
plot_estrutura_delay_tempo = dados_dengue_longo %>% 
  hchart('line', hcaes(x = t, 
                       ...
                       d = d),marker = F,
         showInLegend = T) %>% 
  formatacao_grafico(titulo = "Estrutura de Delay ao longo do Tempo",
                     titulo_x = "Tempo t",
...
plot_N_t_inical = dados_dengue %>% 
  ...
  hchart('line', hcaes(x = t, 
                       ...
                       group = name),marker = F,
         showInLegend = T) %>% 
  formatacao_grafico(titulo = "Total de Casos real e estimado de Dengue no Tempo",
                     titulo_x = "Tempo t",
  ...
  hc_subtitle(
    text = "Estimativa sem incorporar estrutura de Delay"
  )
...
plot_lambda_td = dados_estimados %>% 
  hchart('line', hcaes(x = t, 
                       ...
                       d = d), marker = F,
         showInLegend = T) %>% 
  formatacao_grafico(titulo = "Casos Estimados de Dengue no Tempo por Delay",
                     titulo_x = "Tempo t",
...
plot_estrutura_delay_estimativas = dados_estimados %>% 
  hchart('line', hcaes(x = t,
                       ...
                       d = d), marker = F,
         showInLegend = T)%>% 
  formatacao_grafico(titulo = "Estrutura de Delay no Tempo para os Casos Estimados",
                     titulo_x = "Tempo t",
...
plot_estrutura_delay_estimativas  
