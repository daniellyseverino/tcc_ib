...
* Modelos hierárquicos com abordagem bayesiana:
  ...
  * Estrutura de atraso na notificação conjunta.

* Estimação pontual e intervalar.

* Previsão:

  * Nowcasting: Previsão para as contagens parciais.

  * Forecasting: Previsão para os casos futuros.
...
tags$div(
  ...
  tags$div(
    ...
    padding-right: 0px; margin: 0px;",
    class="col-",
    plot_N_t_modelos %>% hc_size(height = 450)
  )
